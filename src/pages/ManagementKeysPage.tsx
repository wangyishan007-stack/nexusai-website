    ...
    <SettingsLayout activeTab="management-keys">
      <div className="flex-1 p-10 max-w-6xl w-full mx-auto">
        ...
        <div className="mb-8 flex justify-between items-end">
          <div>
            <h2 className="text-3xl font-bold font-headline tracking-tight mb-2">Management Keys</h2>
        ...
        {/* Keys Table */}
        <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/15 mb-8">
          ...
          <div className="divide-y divide-outline-variant/10">
            {MGMT_KEYS.map((key) => (
              <div key={key.prefix} className="flex items-center justify-between px-6 py-4 hover:bg-surface-container-low/50 transition-colors">
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${key.status === "active" ? "bg-primary-container/10 text-primary" : "bg-slate-100 text-slate-400"}`}>
                ...
                <div className="flex items-center gap-8">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button className="p-1.5 text-on-surface-variant hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Audit Log */}
          <div className="lg:col-span-2 bg-surface-container-lowest rounded-xl border border-outline-variant/15">
            <div className="flex justify-between items-center p-6 border-b border-outline-variant/10">
            ...
            <div className="divide-y divide-outline-variant/5">
              {AUDIT_LOG.map((entry, i) => (
                <div key={i} className="flex items-center justify-between px-6 py-3.5 hover:bg-surface-container-low/50 transition-colors">
          ...
          <div className="bg-surface-container-lowest rounded-xl p-6 border border-outline-variant/15">
            ...
            <div className="space-y-4">
              {SCOPE_OPTIONS.map((scope) => (
                <div key={scope.label} className="flex items-start gap-3 p-3 rounded-lg hover:bg-surface-container-low/50 transition-colors">
